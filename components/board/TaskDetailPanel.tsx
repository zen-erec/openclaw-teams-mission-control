    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div>
          ...
          <select
            value={task.status}
            onChange={(e) => onStatusChange(e.target.value as Doc<"tasks">["status"])}
...
export function TaskDetailPanel({ taskId, onClose }: TaskDetailPanelProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className="hidden lg:block fixed right-0 top-0 h-screen w-96 max-w-md border-l border-gray-200 bg-white overflow-y-auto z-40">
        {/* Header */}
